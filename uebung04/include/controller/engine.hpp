...
{
  class Engine: public ::controller::InputEventHandler, public std::enable_shared_from_this<controller::Engine>// TODO 4.1: insert base classes
  {
    public:
    ...
    protected:
      ...
      virtual bool handle(const keyboard_event&);
